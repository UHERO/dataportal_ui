// Edited export-data Highcharts module to format csv export (comment out line 412)
// Allows hidden series to be exported to CSV (i.e. YTD values for non-annual series)
