...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__series_helper_service__ = __webpack_require__("../../../../../src/app/series-helper.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__helper_service__ = __webpack_require__("../../../../../src/app/helper.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__google_analytics_events_service__ = __webpack_require__("../../../../../src/app/google-analytics-events.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__nta_layout_nta_layout_component__ = __webpack_require__("../../../../../src/app/nta/nta-layout/nta-layout.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_16__nta_layout_nta_layout_component__["a" /* NtaLayoutComponent */]
        ],
        imports: [
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_13__series_helper_service__["a" /* SeriesHelperService */],
            __WEBPACK_IMPORTED_MODULE_14__helper_service__["a" /* HelperService */],
            __WEBPACK_IMPORTED_MODULE_15__google_analytics_events_service__["a" /* GoogleAnalyticsEventsService */],
            {
...
var NtaHelperService = NtaHelperService_1 = (function () {
    ...
    NtaHelperService.setCacheId = function (category, routeFreq) {
        var id = '' + category;
        if (routeFreq) {
            id = id + routeFreq;
        }
    ...
    NtaHelperService.prototype.initContent = function (catId, routeFreq) {
        var _this = this;
        var cacheId = NtaHelperService_1.setCacheId(catId, routeFreq);
        if (this.categoryData[cacheId]) {
            ...
            this._uheroAPIService.fetchCategories().subscribe(function (categories) {
                ...
                if (cat) {
                    ...
                    _this.getSubcategoryData(selectedCategory, cacheId, _this.categoryData[cacheId].sublist, routeFreq);
                }
                else {
    ...
    NtaHelperService.prototype.getSubcategoryData = function (catName, cacheId, sublist, routeFreq) {
        var _this = this;
        var freqArray = [];
        ...
        sublist.forEach(function (sub, index) {
            ...
            _this._uheroAPIService.fetchSelectedCategory(sub.id).subscribe(function (category) {
                var freqGeos = category.freqGeos;
                ...
                if (index === sublist.length - 1) {
                    ...
                    var measurementsArray_1 = [];
                    sublist.forEach(function (subcat, i) {
                        var selectedFreq;
                        selectedFreq = _this.defaultFreq ? _this.defaultFreq : freqArray[0].freq;
                        if (routeFreq) {
                            var selected = _this.checkSelectedFreqs(routeFreq, freqArray);
                            selectedFreq = selected.freq;
                        }
                        // Get frequencies available for a selected region
                        var currentFreq = freqArray.find(function (freq) { return freq.freq === selectedFreq; });
                        _this.categoryData[cacheId].frequencies = freqArray;
                        ...
                        _this.getMeasurementData(subcat, currentFreq.freq, _this.categoryData[cacheId], measurementsArray_1);
                    });
                }
            });
        });
    ...
    NtaHelperService.prototype.getMeasurementData = function (subcategory, freq, category, measurementsArray) {
        var _this = this;
        this._uheroAPIService.fetchCategoryMeasurements(subcategory.id).subscribe(function (measurements) {
            ...
            if (_this.requestsRemain === 0) {
                ...
                _this.getSeriesData(category, freq);
            }
        });
    };
    // Get list of series belonging to each measurement
    NtaHelperService.prototype.getSeriesData = function (category, freq) {
        var _this = this;
        var measurements = category.measurements;
        var seriesCount = 0;
        var measurementCount = measurements.length;
        measurements.forEach(function (measurement, mIndex) {
            _this._uheroAPIService.fetchMeasurementSeries(measurement.id, freq).subscribe(function (series) {
                if (series) {
                ...
                if (measurementCount === 0) {
                    _this.getObservationData(category, seriesCount);
                }
            });
        });
    };
    // Get observations beloning to each series
    NtaHelperService.prototype.getObservationData = function (category, seriesCount) {
        var _this = this;
        var measurements = category.measurements;
        measurements.forEach(function (measurement) {
            if (measurement.series) {
                measurement.series.forEach(function (serie) {
                    _this._uheroAPIService.fetchObservations(serie.id).subscribe(function (obs) {
                        ...
                        seriesCount--;
                        if (seriesCount === 0) {
                            _this.formatCategoryData(category);
                        }
                    });
                });
            }
    ...
    NtaHelperService.prototype.formatCategoryData = function (category) {
        var _this = this;
        var categoryDateArray = [];
        var measurements = category.measurements;
        var freq = category.currentFreq.freq;
        var catDateWrapper = category.categoryDateWrapper;
        measurements.forEach(function (measurement) {
            if (measurement.series) {
                measurement.displaySeries = _this.filterSeries(measurement.series, freq, catDateWrapper);
            }
        });
        ...
        measurements.forEach(function (measurement, i) {
            if (measurement.series) {
                var displaySeries = measurement.displaySeries;
                displaySeries.forEach(function (series) {
                    series.seriesInfo.title = series.seriesInfo.geography.name;
                    var catData = _this.formatSeriesData(series, categoryDateArray);
    ...
    NtaHelperService.prototype.checkSelectedFreqs = function (routeFreq, freqArray) {
    ...
    NtaHelperService.prototype.filterSeries = function (seriesArray, freq, categoryDateWrapper) {
        var _this = this;
        var filtered = [];
        seriesArray.forEach(function (res) {
            ...
            if (levelData) {
                ...
                categoryDateWrapper.firstDate = _this.setStartDate(categoryDateWrapper, seriesObsStart);
                categoryDateWrapper.endDate = _this.setEndDate(categoryDateWrapper, seriesObsEnd);
    ...
    NtaHelperService.prototype.setStartDate = function (categoryDateWrapper, observationStart) {
    ...
    NtaHelperService.prototype.setEndDate = function (categoryDateWrapper, observationEnd) {
    ...
    NtaHelperService.prototype.formatSeriesData = function (series, categoryDateArray) {
        ...
        var catTable = this._helper.catTable(series.tableData, categoryDateArray, decimals);
...
var NtaLayoutComponent = (function () {
    function NtaLayoutComponent(_uheroAPIService, _ntaHelper, route, _router, cdRef) {
        this._uheroAPIService = _uheroAPIService;
    ...
    NtaLayoutComponent.prototype.ngAfterViewInit = function () {
        ...
        this.sub = this.route.queryParams.subscribe(function (params) {
            ...
            _this.categoryData = _this.getData(_this.id, _this.routeFreq);
    ...
    NtaLayoutComponent.prototype.getData = function (id, freq) {
    ...
    NtaLayoutComponent.prototype.redrawSeriesFreq = function (event, subId) {
        var _this = this;
        this.loading = true;
        setTimeout(function () {
    ...
    NtaLayoutComponent.prototype.yoyActive = function (e, subId) {
        var _this = this;
        this.loading = true;
        setTimeout(function () {
    ...
    NtaLayoutComponent.prototype.ytdActive = function (e, subId) {
        var _this = this;
        this.loading = true;
        setTimeout(function () {
    ...
    NtaLayoutComponent.prototype.changeRange = function (e) {
...
NtaLayoutComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__uhero_api_service__["a" /* UheroApiService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__uhero_api_service__["a" /* UheroApiService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__nta_helper_service__["a" /* NtaHelperService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__nta_helper_service__["a" /* NtaHelperService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"]) === "function" && _e || Object])
], NtaLayoutComponent);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_platform_browser_dynamic__["a" /* platformBrowserDynamic */])().bootstrapModule(__WEBPACK_IMPORTED_MODULE_3__app_nta_app_module__["a" /* AppModule */]);
